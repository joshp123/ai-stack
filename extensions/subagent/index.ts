...
const ThinkingSchema = StringEnum(["off", "minimal", "low", "medium", "high", "xhigh"] as const, {
	description: "Thinking level override for subagent run.",
});

const OverrideSchema = {
	model: Type.Optional(Type.String({ description: "Model override for subagent run." })),
	thinking: Type.Optional(ThinkingSchema),
	tools: Type.Optional(Type.Array(Type.String(), { description: "Override tools for subagent run." })),
	systemPrompt: Type.Optional(Type.String({ description: "Append system prompt override for subagent run." })),
};
