...
1) User writes seed outline + pins the Dec 9 letter (seed evidence).
   ...
   - API: CreateRun(profile=spotify-2025-12-09-forensic-reply)
   - State: INTENT_SEED
...
- Model: Opus 4.5
- Thinking: max
- Credential lookup: same paths as openclaw (see libs/pi/README.md)
...
```
profile {
  profile_id: "spotify-2025-12-09-forensic-reply"
